...
namespace muzi
{
    public class DialogForm : UGuiForm
    {
        ...
        private void RefreshConfirmText(string confirmText)
        {
            ...
            {
                confirmText = "确定";// EntryInstance.Localization.GetString("Dialog.ConfirmButton");
            }
        ...
        private void RefreshCancelText(string cancelText)
        {
            ...
            {
                cancelText = "取消";// EntryInstance.Localization.GetString("Dialog.CancelButton");
            }
        ...
        private void RefreshOtherText(string otherText)
        {
            ...
            {
                otherText = "其它";// EntryInstance.Localization.GetString("Dialog.OtherButton");
            }
