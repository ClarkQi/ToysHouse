...
namespace muzi
{
    public static class ZipUtility
    {
        ...
        public static void AsyncUnzipFile(string _filePathName, string _outputPath, string _password = null, UnzipCallback _unzipCallback = null)
        {
            Thread thread = new Thread(() => {
                UnzipFile(_filePathName, _outputPath, _password, _unzipCallback);
            });
            thread.Start();
        }
